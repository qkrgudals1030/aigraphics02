...
class App{
    ...
    _setupModel(){
        ...
        async function loadFont(that) {
            ...
            const geometry = new TextGeometry("Ai Graphics", {
                font : font, 
                size : 3, 
                height : 1.0, 
                curveSegments : 4, 
            ...
            const fillMaterial = new THREE.MeshPhongMaterial({color : 0x8b00ff}); 
            const cube = new THREE.Mesh(geometry, fillMaterial); 
    
            const lineMaterial = new THREE.LineBasicMaterial({color : 0x8b00ff}); 
